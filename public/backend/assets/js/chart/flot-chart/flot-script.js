    ...
    function plotAccordingToChoices() {
        ...
        if (data.length > 0) {
            $.plot("#toggling-series-flot", data, {
                ...
                colors: [BohoAdminConfig.primary, "#f8d62b", "#a927f9", "#51bb25", BohoAdminConfig.secondary, "#dc3545", "#f8d62b"]
...
$(function () {
    ...
    var data = [
        ...
        { color: "#33BFBF", bars: { show: true, align: "center", barWidth: 0.25 }, data: data4, label: "data4" },
...
$(function () {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [BohoAdminConfig.primary, "#51bb25", "#f8d62b", "#a927f9", "#dc3545", "#6c757d", BohoAdminConfig.secondary]
    });
