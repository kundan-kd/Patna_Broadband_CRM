(function ($) {
    ...
    setTimeout(function () {
        $("#line-chart-sparkline").sparkline([5, 10, 20, 14, 17, 21, 20, 10, 4, 13, 0, 10, 30, 40, 10, 15, 20], {
            ...
            lineColor: BohoAdminConfig.primary,
            fillColor: 'rgba(145, 46, 252, 0.40)',
            highlightLineColor: BohoAdminConfig.primary,
            highlightSpotColor: BohoAdminConfig.primary,
            targetColor: BohoAdminConfig.primary,
            performanceColor: BohoAdminConfig.primary,
            boxFillColor: BohoAdminConfig.primary,
            medianColor: BohoAdminConfig.primary,
            minSpotColor: BohoAdminConfig.primary
        });
    });
    ...
    $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
        ...
        tooltipClassname: 'chart-sparkline',
        chartRangeMax: '50',
        lineColor: BohoAdminConfig.secondary,
...
var sparkline_chart = {
    init: function () {
        setTimeout(function () {
            ...
            height: '100%',
            tooltipClassname: 'chart-sparkline',
            barColor: BohoAdminConfig.primary
        }), $("#pie-sparkline-chart").sparkline([1.5, 1, 1, 0.5], {
            type: 'pie',
            width: '100%',
            height: '100%',
            sliceColors: ['#51bb25', '#f8d62b', BohoAdminConfig.secondary, BohoAdminConfig.primary],
            tooltipClassname: 'chart-sparkline'
        });
    }
};
