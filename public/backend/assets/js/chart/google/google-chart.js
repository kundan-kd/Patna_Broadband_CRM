...
function drawBasic() {
  ...
  if ($("#pie-chart1").length > 0) {
    ...
    var options = {
      ...
      width: '100%',
      height: 300,
      colors: ["#f8d62b", "#51bb25", "#a927f9", BohoAdminConfig.secondary, BohoAdminConfig.primary]
    };
  ...
  if ($("#pie-chart2").length > 0) {
    ...
    var options = {
      ...
      width: '100%',
      height: 300,
      colors: ["#f8d62b", "#a927f9", "#51bb25", BohoAdminConfig.secondary, BohoAdminConfig.primary]
    };
  ...
  if ($("#pie-chart4").length > 0) {
    ...
    var options = {
      ...
      colors: ["#dc3545", BohoAdminConfig.primary, BohoAdminConfig.secondary, "#51bb25", "#a927f9", "#f8d62b", "#dc3545", BohoAdminConfig.primary, "#f8d62b", "#51bb25", BohoAdminConfig.primary, BohoAdminConfig.secondary, "#51bb25", BohoAdminConfig.primary, "#a927f9", "#f8d62b", BohoAdminConfig.primary, BohoAdminConfig.primary, "#a927f9", BohoAdminConfig.secondary, BohoAdminConfig.primary, "#51bb25"]
    };
...
function drawChart() {
  ...
  data.addRows([
    ...
    ['Write', 'Write paper', 'write',
      null, new Date(2022, 0, 9), daysToMilliseconds(3), 25, 'Research,Outline'],
  ...
  var options = {
    ...
    gantt: {
      ...
      palette: [
        {
          "color": BohoAdminConfig.primary,
          "dark": BohoAdminConfig.secondary,
          "light": "#047afb"
        }
      ]
