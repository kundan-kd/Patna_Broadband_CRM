...
var barData = {
    ...
    datasets: [{
        ...
        strokeColor: BohoAdminConfig.primary,
        highlightFill: "rgba(115, 102 ,255, 0.6)",
        highlightStroke: BohoAdminConfig.primary,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(247, 49, 100, 0.4)",
        strokeColor: BohoAdminConfig.secondary,
        highlightFill: "rgba(247, 49, 100, 0.6)",
        highlightStroke: BohoAdminConfig.secondary,
...
var polarData = [
    {
        ...
        highlight: BohoAdminConfig.primary,
        label: "Yellow"
    }, {
        value: 50,
        color: "#f8d62b",
        ...
        value: 120,
        color: BohoAdminConfig.secondary,
        highlight: BohoAdminConfig.secondary,
        label: "Dark Grey"
    }
];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: BohoAdminConfig.primary,
        pointColor: BohoAdminConfig.primary,
        ...
        strokeColor: BohoAdminConfig.secondary,
        pointColor: BohoAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: BohoAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: BohoAdminConfig.primary,
        pointColor: BohoAdminConfig.primary,
        pointStrokeColor: BohoAdminConfig.primary,
        pointHighlightFill: BohoAdminConfig.primary,
