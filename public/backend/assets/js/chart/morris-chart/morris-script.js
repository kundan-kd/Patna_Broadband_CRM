...
var morris_chart = {
    init: function () {
        Morris.Area({
            ...
            ykeys: ['y', 'z'],
            labels: ['Y', 'Z'],
            lineColors: [BohoAdminConfig.secondary, BohoAdminConfig.primary],
        }), Morris.Line({
            ...
            xkey: "y",
            ykeys: ["a", "b"],
            lineColors: [BohoAdminConfig.primary, BohoAdminConfig.secondary],
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: [BohoAdminConfig.primary, BohoAdminConfig.secondary, "#51bb25"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            ykeys: ["y"],
            labels: ["Y"],
            barColors: [BohoAdminConfig.primary]
        }), $(function () {
            var b = [{
                period: "2012-10-01",
                licensed: 5000,
            ...
            Morris.Bar({
                ...
                data: b,
                barColors: [BohoAdminConfig.primary, BohoAdminConfig.secondary],
                xkey: "period",
            ...
            window.m = Morris.Line({
                ...
                labels: ["sin(x)"],
                parseTime: !1,
                lineColors: [BohoAdminConfig.primary],
            ...
            Morris.Donut({
                ...
                labelColor: "#999999",
                colors: [BohoAdminConfig.primary, BohoAdminConfig.secondary, "#f8d62b", "#51bb25", "rgba(248, 214, 43, 1)", "#51bb25", "#f8d62b"],
            ...
            $(function () {
                ...
                Morris.Bar({
                    ...
                    ykeys: ["y", "z", "a"],
                    labels: ["A", "Y", "Z"],
                    barColors: [BohoAdminConfig.primary, BohoAdminConfig.secondary, "#51bb25", "#f8d62b", "#a927f9", BohoAdminConfig.secondary, BohoAdminConfig.primary],
                    stacked: !0
                });
            });
    }
