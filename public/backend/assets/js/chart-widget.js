(function ($) {
  ...
  var optionslinechart2 = {
    ...
    colors: [BohoAdminConfig.secondary],
    series: [
      {
        name: "series1",
        data: [70, 60, 82, 80, 60, 90, 70, 120, 50, 60, 0],
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: BohoAdminConfig.primary,
          label: {
            borderColor: BohoAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: BohoAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionssaleschart = {
    ...
    colors: [BohoAdminConfig.darkcolor, "#C1E9C1"],
    chart: {
      height: 300,
      type: "radar",
      dropShadow: {
  ...
  var optionsCircle = {
    ...
    colors: [BohoAdminConfig.secondary, BohoAdminConfig.primary, "#4AAD8A"],
    responsive: [{
      breakpoint: 767,
      options: {
        title: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [BohoAdminConfig.primary],
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [BohoAdminConfig.primary],
      },
    },
    series: [
      {
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [BohoAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
    ...
    fill: {
      ...
      gradient: {
        inverseColors: false,
        gradientToColors: [BohoAdminConfig.secondary],
      },
    },
    tooltip: {
      custom: function ({ series, seriesIndex, dataPointIndex, w }) {
  ...
  var optionsProgress3 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [BohoAdminConfig.darkcolor],
          backgroundBarOpacity: 0.2,
          backgroundBarRadius: 10,
        },
      },
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [BohoAdminConfig.darkcolor],
      },
    },
    title: {
      floating: true,
  ...
  var optionsProgress4 = {
    ...
    colors: [BohoAdminConfig.lightcolor],
    stroke: {
      width: 0,
    },
    series: [
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [BohoAdminConfig.lightcolor],
      },
    },
    title: {
      floating: true,
