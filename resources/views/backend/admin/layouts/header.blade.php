      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="nav-right col-auto pull-right right-header p-0 ms-auto">
            <ul class="nav-menus">
              <li class="onhover-dropdown serchinput">
                <p class="mb-0 search header-search serchbox">
                  <svg>
                ...
                <div class="onhover-show-div notification-dropdown">
                  ...
                  <ul>
                    <li class="b-t-primary border-4">
                      <p><a href="product.html">Delivery processing  </a><span class="font-danger">10 min.</span></p>
                    </li>
                    <li class="b-t-success border-4">
                      <p><a href="order-history.html">Order Complete</a><span class="font-success">1 hr</span></p>
                    </li>
                    <li class="b-t-secondary border-4">
                      <p><a href="checkout.html">Tickets Generated</a><span class="font-secondary">3 hr</span></p>
                    </li>
                    <li class="b-t-warning border-4">
                      <p><a href="list-products.html">Delivery Complete</a><span class="font-warning">6 hr</span></p>
                    </li>
                        ...
                        <ul class="bookmark-dropdown">
                          <li>
                            <div class="row">
                              ...
                              <div class="col-4 text-center"><a href="email-application.html">
                                  <div class="bookmark-content">
                    ...
                    <li>
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1"> <a href="chat.html">
                            ...
                            <p>Change for anyone Chat😅.</p></a></div><span>35 min.</span>
                      </div>
                    </li>
                    <li>
                      <div class="d-flex">
              ...
              {{-- <li class="cart-nav onhover-dropdown">
                ...
                <div class="cart-dropdown onhover-show-div">
                  ...
                  <ul>
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 me-3" src="../assets/images/dashboard-2/product/1.png" alt="">
                        <div class="flex-grow-1"><a href="product.html"> <span>Furniture Chair for Home</span></a>
                          <div class="qty-box">
                    ...
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 me-3" src="../assets/images/dashboard-2/product/2.png" alt="">
                        <div class="flex-grow-1"><a href="product.html"> <span>The best office table</span></a>
                          <div class="qty-box">
                            <div class="input-group"> <span class="input-group-prepend">
                                <button class="btn quantity-left-minus" type="button" data-type="minus" data-field="">-</button></span>
                              <input class="form-control input-number f-14 f-w-500" type="text" name="quantity" value="1"><span class="input-group-prepend">
                    ...
                    <li> <a class="d-block view-cart btn bg-primary text-white text-center f-w-700" href="cart.html">Go to your cart</a></li>
                    <li class="text-center check-button"><a class="btn btn-primary view-checkout" href="checkout.html">Checkout  </a></li>
                  </ul>
                </div>
              </li> --}}
          ...
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">xxxxxx</div>
            </div>
            </div>
          </script>
      ...
      <div class="page-sub-header" data-layout="stroke-svg"> 
        <div class="body-header">
          <ul class="sidebar-body-menu">
            <li>
              ...
              {{-- <ul class="sidebar-body-mainmenu custom-scrollbar"> 
                <li> <a href="#"> 
                    ...
                    </svg>Dashboard </a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                    <li><a href="index.html">Ecommerce</a></li>
                    <li><a href="dashboard-02.html">Default</a></li>
                  </ul>
                </li>
                <li> <a href="#"> 
                    <svg class="stroke-icon">
                    ...
                    </svg>Widgets</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
            ...
            <li>
              ...
              {{-- <ul class="sidebar-body-mainmenu custom-scrollbar"> 
                <li> <a href="#"> 
                    ...
                    </svg>Project </a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Ecommerce</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Email</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Chat</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Users</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
            ...
            <li>
              ...
              {{-- <ul class="sidebar-body-mainmenu custom-scrollbar"> 
                <li> <a href="#"> 
                    ...
                    </svg>Form Controls</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Form Widgets</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg> Form layout</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Bootstrap Tables</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    <svg class="fill-icon">
                      <use href="../assets/svg/icon-sprite.svg#fill-task"></use>
                    </svg>Data Tables</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
            ...
            <li>
              ...
              {{-- <ul class="sidebar-body-mainmenu custom-scrollbar"> 
                <li> <a href="#"> 
                    ...
                    </svg>Ui Kits</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Bonus Ui</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Animation</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Icons</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Buttons</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Charts</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
            ...
            <li>
              <div> 
                <h3 class="lan-9#">Pages</h3>
              </div>
              {{-- <ul class="sidebar-body-mainmenu custom-scrollbar"> 
                <li> <a href="landing-page.html"> 
                    <svg class="stroke-icon">
                      <use href="../assets/svg/icon-sprite.svg#stroke-landing-page"></use>
                    </svg>
                    <svg class="fill-icon">
                ...
                <li> <a href="../starter-kit/index.html" target="_blank"> 
                    <svg class="stroke-icon">
                ...
                <li> <a href="#"> 
                    ...
                    <svg class="fill-icon">
                      <use href="../assets/svg/icon-sprite.svg#fill-landing-page"></use>
                    </svg>Error Page</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    <svg class="fill-icon">
                      <use href="../assets/svg/icon-sprite.svg#fill-board"></use>
                    </svg>Authentication</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Coming Soon</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    <svg class="fill-icon">
                      <use href="../assets/svg/icon-sprite.svg#fill-email"></use>
                    </svg>Email templates</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
            ...
            <li>
              <div> 
                <h3 class="lan-11#">Miscellaneous</h3>
              </div>
              {{-- <ul class="sidebar-body-mainmenu custom-scrollbar"> 
                <li> <a href="#"> 
                    <svg class="stroke-icon">
                    ...
                    </svg>Gallery</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Blog</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Job Search</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Learning</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Maps</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
                ...
                <li> <a href="#"> 
                    ...
                    </svg>Editors</a><span class="sub-body-arrow"><i class="fa fa-angle-right"></i></span>
                  <ul class="sidebar-body-submenu custom-scrollbar"> 
